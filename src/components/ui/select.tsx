...
/**
 * Lightweight styled wrapper over the native ``<select>``. Keeps the bundle
 * dependency-free while matching the shadcn visual language. For richer
 * combobox behaviour we can later swap in @radix-ui/react-select without
